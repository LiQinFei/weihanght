<template>
  <div class="log" v-loading.fullscreen.lock="fullscreenLoading">
    ...
    <div class="inputs">
      <el-form :inline="true" :model="search" class="demo-form-inline">
        <el-form-item label="操作用户名称">
          <el-input v-model="search.operateName" placeholder="请输入"></el-input>
        </el-form-item>
    ...
    <el-table ref="multipleTable" :data="tableData.dataList" border style="width: 100%" v-loading="loading">
      ...
      <el-table-column  prop="operateName" label="操作用户" width="150">
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$http({
          method: "post",
          url: url + "/clientFindLogListAndPaged",
          data: that.search
        }).then(function(res) {
          that.loading = false;
